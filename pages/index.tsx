...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Popup name={help || ""}/>
      {help ? <div className='md:relative fixed md:top-32 md:left-44 top-[5%] left-[90%] inline-block cursor-pointer active:animate-size z-50' onClick={() => setHelp("")}><Image src={crossI} width={20} height={20}/></div> : ""}
